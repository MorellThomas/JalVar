        ...
        implements ext.vamsas.MuscleWS
{
          ...
          throws java.rmi.RemoteException
  {
    ...
    else
    {
      ...
      {
        return (vamsas.objects.simple.Alignment) org.apache.axis.utils.JavaUtils
                .convert(_resp, vamsas.objects.simple.Alignment.class);
      }
    }
  }
          ...
          throws java.rmi.RemoteException
  {
    ...
    else
    {
      ...
      {
        return (vamsas.objects.simple.MsaResult) org.apache.axis.utils.JavaUtils
                .convert(_resp, vamsas.objects.simple.MsaResult.class);
      }
    }
  }
